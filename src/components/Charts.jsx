...
const Charts = ({ activeTimeFilter, statsData, setStatsData }) => {
  ...
  const pieData = {
    Investments: [
      { label: "Equity", value: 50, color: "#3b82f6" },
      { label: "Debt", value: 30, color: "#10b981" },
      { label: "Other", value: 20, color: "#f59e0b" },
    ],
    Users: [
      { label: "Investor", value: 40, color: "#3b82f6" },
      { label: "Trader", value: 35, color: "#10b981" },
      { label: "Company", value: 25, color: "#f59e0b" },
    ],
    Revenue: [
      { label: "Equity", value: 45, color: "#3b82f6" },
      { label: "Debt", value: 35, color: "#10b981" },
      { label: "Other", value: 20, color: "#f59e0b" },
    ],
  }
  ...
  const pieChartData = calculatePieAngles(pieData[activeTab])
        ...
        <div className="pie-chart-card">
          <div className="pie-chart" style={{ position: "relative" }}>
            ...
            {hoverPieIndex !== null && (
              ...
              >
                {pieChartData[hoverPieIndex].label}: {pieChartData[hoverPieIndex].value}% ({pieChartData[hoverPieIndex].value})
              </div>
            )}
          </div>
