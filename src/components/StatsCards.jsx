  ...
  const renderChart = (type) => {
      ...
      return (
        <div className="mini-chart">
          <svg width="60" height="30" viewBox="0 0 60 30">
            <polyline points="0,25 15,20 30,15 45,10 60,5" stroke="#10b981" strokeWidth="2" fill="none" />
          </svg>
        </div>
      )
    }
    ...
    if (type === "line-down") {
      return (
        <div className="mini-chart">
          <svg width="60" height="30" viewBox="0 0 60 30">
            <polyline points="0,5 15,8 30,12 45,18 60,25" stroke="#ef4444" strokeWidth="2" fill="none" />
          </svg>
        </div>
      )
    }
